    ...
    public class ClientService : Service<Client>, IClientService
    {
        ...
        public List<ClientListVM> GetAllClientsByOwnerId(long ownerid)
        {
            ...
            new ClientListVM
            {
                ...
                DateOfBirth = x.UserOwner.clients.DateOfBirth.GetValueOrDefault(),
        ...
        {
            Client clientdata = base.Queryable().FirstOrDefault(x => x.Id == entity.Id && x.Active == true && x.Deleted == false);
            if (clientdata != null)
            {
                clientdata.UpdatedAt = DateTime.Now;
                clientdata.UpdatedBy = entity.Id;
                ...
                _repository.Update(clientdata);
                _unitOfWork.SaveChanges();
                Address userdata = _repository.GetRepository<Address>().Queryable().FirstOrDefault(x => x.OwnerId == clientdata.Id && x.Active == true && x.Deleted == false);
                if (userdata != null)
                {
