...
export class GroupsInfoComponent implements OnInit {
  ...
  uptInstruments() {
    this.updtInstruments = {
      ...
      MarginCurrency: this.groupsinfoForm.value.margincurrency,
      Description: this.groupsinfoForm.value.description,
      ...
      CalculationMode: this.groupsinfoForm.value.calculationmode,
      Commission: this.groupsinfoForm.value.commission,
      SwapType: this.groupsinfoForm.value.swaptype,
      ThreeDaysSwap: this.groupsinfoForm.value.threedaysswap,
      CommissionCurrency: this.groupsinfoForm.value.commissioncurrency,
